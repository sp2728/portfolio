...
(window["webpackJsonp"] = window["webpackJsonp"] || []).push([["main"], {
    ...
    var BlogsComponent = /*#__PURE__*/function () {
      ...
      _createClass(BlogsComponent, [{
        ...
        value: function getBlogsData() {
          ...
          this.http.getBlogsAndCertifications().then(function (response) {
            if (response.success) {
              _this3.blogs = response.data.blogs;
              _this3.certifications = response.data.certifications;
            }
          });
        }
      }]);
    ...
    var EducationComponent = /*#__PURE__*/function () {
      ...
      _createClass(EducationComponent, [{
        ...
        value: function getEducationDetails() {
          ...
          this.http.getEducationDetails().then(function (response) {
            if (response.success) {
  ...
  /***/
  function srcAppModelsDataModelTs(module, __webpack_exports__, __webpack_require__) {
    "use strict";
    ...
    var ProfileComponent = /*#__PURE__*/function () {
      ...
      _createClass(ProfileComponent, [{
        ...
        value: function getProfile() {
          ...
          this.http.getProfile().then(function (response) {
            if (response.success) {
              _this5.profile = response.data;
            }
          });
        }
      }]);
  ...
  function srcAppServicesDataServiceTs(module, __webpack_exports__, __webpack_require__) {
    ...
    var _models_data_model__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(
    /*! ../models/data.model */
    "./src/app/models/data.model.ts");
    ...
    var DataService = /*#__PURE__*/function () {
      ...
      _createClass(DataService, [{
        key: "getProfile",
        value: function getProfile() {
          return this.http.get('assets/data/profile.json').pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_3__["map"])(function (response) {
            if (response) {
              var profile = new _models_data_model__WEBPACK_IMPORTED_MODULE_4__["Profile"]().adapter(response.profile);
              return {
                success: true,
                data: profile
              };
        ...
        value: function getSkills() {
          return this.http.get('assets/data/technologies.json').pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_3__["map"])(function (response) {
            if (response) {
              var skills = response.skills.map(function (data) {
        ...
        key: "getBlogsAndCertifications",
        value: function getBlogsAndCertifications() {
          return this.http.get('assets/data/blogs.json').pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_3__["map"])(function (response) {
            if (response) {
              var blogs = response.blogs.map(function (data) {
                return new _models_data_model__WEBPACK_IMPORTED_MODULE_4__["Blog"]().adapter(data);
              });
              var certifications = response.certifications.map(function (data) {
        ...
        key: "getProjects",
        value: function getProjects() {
          return this.http.get('assets/data/projects.json').pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_3__["map"])(function (response) {
            if (response) {
              var projects = response.projects.map(function (data) {
        ...
        key: "getEducationDetails",
        value: function getEducationDetails() {
          return this.http.get('assets/data/education.json').pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_3__["map"])(function (response) {
            if (response) {
              var schools = response.education.map(function (data) {
  ...
  function srcAppTechnologiesTechnologiesComponentTs(module, __webpack_exports__, __webpack_require__) {
    ...
    TechnologiesComponent = tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["Component"])({
